...
public class EscapeBoardCheckerTest {
    ...
    void inBounds_XInfinite_YInfinite()
    {
        ...
        assertTrue(boundsChecker.isInBounds(new EscapeCoordinate(-1, 1000)));
    }
    ...
    void inBounds_XInfinite_YFinite()
    {
        ...
        assertTrue(boundsChecker.isInBounds(new EscapeCoordinate(-12, 10)));
    }
    ...
    void inBounds_XFinite_YInfinite()
    {
        ...
        assertTrue(boundsChecker.isInBounds(new EscapeCoordinate(2, 51)));
    }
    ...
    void inBounds_XFinite_YFinite()
    {
        ...
        assertTrue(boundsChecker.isInBounds(new EscapeCoordinate(12, 1)));
    }
    ...
    {
        BoundsChecker boundsChecker = new BoundsChecker(0, 10);
        assertFalse(boundsChecker.isInBounds(new EscapeCoordinate(-2, 12)));
    }
    ...
    {
        BoundsChecker boundsChecker = new BoundsChecker(49, 0);
        assertFalse(boundsChecker.isInBounds(new EscapeCoordinate(-1, 20)));
    }
    ...
    {
        BoundsChecker boundsChecker = new BoundsChecker(12, 12);
        assertFalse(boundsChecker.isInBounds(new EscapeCoordinate(13, 13)));
    }
